      ...
      <div class="container">
        <div class="features-content-wrapper">
          ...
          <div class="box-content">
            <h2>In the box</h2>
            <div class="box-list">
              <p>2x <span>Speaker Unit</span></p>
              <p>2x <span>Speaker Cloth Panel</span> </p>
              <p>1x <span>User Manual</span> </p>
              <p>1x <span>3.5mm 10m Audio Cable</span> </p>
              <p>1x <span>10m Optical Cable</span> </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="related-wrapper">
          <div class="related-item">
            ...
            <p class="related-title">ZX7 Speaker</p>
            <router-link to="/zx7-speaker" class="site-btn">See product</router-link>
          </div>
          <div class="related-item">
  ...
  data() {
    return {
      currentProduct: {
        ...
        shortname: 'ZX9',
        price: 4500,
        cartImg: '../img/cart/image-zx9-speaker.jpg'
      }
    }
  },
  name: "ZX7 Speaker",
  ...
  .product-container {
    ...
    .product-img {
      ...
      &.product-img {
        ...
        @media (max-width: 1024px) {
          background: url('../assets/img/product-zx9-speaker/tablet/image-product.jpg') center/contain no-repeat, $color3;
        }
        @media (max-width: 767px) {
  ...
  .gallery-wrapper {
    ...
    .gallery-block {
      ...
      &.big-block {
        width: 635px;
        height: 592px;
        background: url('../assets/img/product-zx9-speaker/desktop/image-gallery-3.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          width: 60%;
          height: 368px;
          background: url('../assets/img/product-zx9-speaker/tablet/image-gallery-3.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          width: 100%;
          height: 368px;
          background: url('../assets/img/product-zx9-speaker/mobile/image-gallery-3.jpg') center/cover no-repeat;
        }
      }
    }
    ...
    .left-gallery {
      ...
      .gallery-img1 {
        margin-bottom: 32px;
        background: url('../assets/img/product-zx9-speaker/desktop/image-gallery-1.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          margin-bottom: 20px;
          background: url('../assets/img/product-zx9-speaker/tablet/image-gallery-1.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          background: url('../assets/img/product-zx9-speaker/mobile/image-gallery-1.jpg') center/cover no-repeat;
        }
      }

      .gallery-img2 {
        background: url('../assets/img/product-zx9-speaker/desktop/image-gallery-2.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          background: url('../assets/img/product-zx9-speaker/tablet/image-gallery-2.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          margin-bottom: 20px;
          background: url('../assets/img/product-zx9-speaker/mobile/image-gallery-2.jpg') center/cover no-repeat;
        }
      }
    }
  }
  ...
  .related-wrapper {
    ...
    .related-item {
      ...
      .img-wrapper {
        ...
        &.related-1 {
          background: url('../assets/img/product-zx7-speaker/desktop/image-product.jpg') center/cover no-repeat, $color3;

          @media (max-width: 1024px) {
            background: url('../assets/img/product-zx7-speaker/tablet/image-product.jpg') center/cover no-repeat, $color3;
          }

          @media (max-width: 767px) {
            background: url('../assets/img/product-zx7-speaker/mobile/image-product.jpg') center/contain no-repeat, $color3;
          }
        }
