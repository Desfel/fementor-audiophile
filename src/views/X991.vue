      ...
      <div class="container">
        ...
        <div class="related-wrapper">
          <div class="related-item">
            ...
            <p class="related-title">XX99 Mark II</p>
            <router-link to="/xx99-mark-ii-headphones" class="site-btn">See product</router-link>
          </div>
          <div class="related-item">
  ...
  data() {
    return {
      currentProduct: {
        ...
        price: 1750,
        cartImg: '../img/cart/image-xx99-mark-one-headphones.jpg'
      }
    }
  },
  name: "X99 Mark I Headphones",
  ...
  .product-container {
    ...
    .product-img {
      ...
      &.product-img {
        ...
        @media (max-width: 1024px) {
          background: url('../assets/img/product-xx99-mark-one-headphones/tablet/image-product.jpg') center/contain no-repeat, $color3;
        }
        @media (max-width: 767px) {
  ...
  .gallery-wrapper {
    ...
    .gallery-block {
      ...
      &.big-block {
        width: 635px;
        height: 592px;
        background: url('../assets/img/product-xx99-mark-one-headphones/desktop/image-gallery-3.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          width: 60%;
          height: 368px;
          background: url('../assets/img/product-xx99-mark-one-headphones/tablet/image-gallery-3.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          width: 100%;
          height: 368px;
          background: url('../assets/img/product-xx99-mark-one-headphones/mobile/image-gallery-3.jpg') center/cover no-repeat;
        }
      }
    }
    ...
    .left-gallery {
      ...
      .gallery-img1 {
        margin-bottom: 32px;
        background: url('../assets/img/product-xx99-mark-one-headphones/desktop/image-gallery-1.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          margin-bottom: 20px;
          background: url('../assets/img/product-xx99-mark-one-headphones/tablet/image-gallery-1.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          background: url('../assets/img/product-xx99-mark-one-headphones/mobile/image-gallery-1.jpg') center/cover no-repeat;
        }
      }

      .gallery-img2 {
        background: url('../assets/img/product-xx99-mark-one-headphones/desktop/image-gallery-2.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          background: url('../assets/img/product-xx99-mark-one-headphones/tablet/image-gallery-2.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          margin-bottom: 20px;
          background: url('../assets/img/product-xx99-mark-one-headphones/mobile/image-gallery-2.jpg') center/cover no-repeat;
        }
      }
    }
  }
    ...
    .related-item {
      ...
      .img-wrapper {
        ...
        &.related-1 {
          ...
          @media (max-width: 1024px) {
            background: url('../assets/img/product-xx99-mark-two-headphones/tablet/image-product.jpg') center/cover no-repeat, $color3;
          }
