      ...
      <div class="container">
        <div class="features-content-wrapper">
          ...
          <div class="box-content">
            <h2>In the box</h2>
            <div class="box-list">
              <p>1x <span>Earphone Unit</span></p>
              <p>2x <span>Multi-size Earplugs</span> </p>
              <p>1x <span>User Manual</span> </p>
              <p>1x <span>USB-C Charging Cable</span> </p>
              <p>1x <span>Travel Pouch</span> </p>
            </div>
          </div>
        </div>
      </div>
...
.product-wrapper {
  ...
  .product-container {
    ...
    .product-img {
      ...
      &.product-img {
        background: url('../assets/img/product-yx1-earphones/desktop/image-product.jpg') center/cover no-repeat, $color3;

        @media (max-width: 1024px) {
          background: url('../assets/img/product-yx1-earphones/tablet/image-product.jpg') center/contain no-repeat, $color3;
        }
        @media (max-width: 767px) {
          background: url('../assets/img/product-yx1-earphones/mobile/image-product.jpg') center/contain no-repeat, $color3;
        }
      }
    }
  ...
  .gallery-wrapper {
    ...
    .gallery-block {
      ...
      &.big-block {
        width: 635px;
        height: 592px;
        background: url('../assets/img/product-yx1-earphones/desktop/image-gallery-3.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          width: 60%;
          height: 368px;
          background: url('../assets/img/product-yx1-earphones/tablet/image-gallery-3.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          width: 100%;
          height: 368px;
          background: url('../assets/img/product-yx1-earphones/mobile/image-gallery-3.jpg') center/cover no-repeat;
        }
      }
    }
    ...
    .left-gallery {
      ...
      .gallery-img1 {
        margin-bottom: 32px;
        background: url('../assets/img/product-yx1-earphones/desktop/image-gallery-1.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          margin-bottom: 20px;
          background: url('../assets/img/product-yx1-earphones/tablet/image-gallery-1.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          background: url('../assets/img/product-yx1-earphones/mobile/image-gallery-1.jpg') center/cover no-repeat;
        }
      }

      .gallery-img2 {
        background: url('../assets/img/product-yx1-earphones/desktop/image-gallery-2.jpg') center/cover no-repeat;

        @media (max-width: 1024px) {
          background: url('../assets/img/product-yx1-earphones/tablet/image-gallery-2.jpg') center/cover no-repeat;
        }

        @media (max-width: 767px) {
          margin-bottom: 20px;
          background: url('../assets/img/product-yx1-earphones/mobile/image-gallery-2.jpg') center/cover no-repeat;
        }
      }
    }
  }
